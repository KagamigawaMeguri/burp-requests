...
public class BurpExtender implements IBurpExtender, IContextMenuFactory, ClipboardOwner {
    ...
    public List<JMenuItem> createMenuItems(IContextMenuInvocation invocation) {
        ...
        i1.addActionListener(e -> copyMessages(messages, false));
        JMenuItem i2 = new JMenuItem(SESSION_MENU_ITEM);
        i2.addActionListener(e -> copyMessages(messages, true));
    ...
    private void copyMessages(IHttpRequestResponse[] messages, boolean withSessionObject) {
        ...
        if (withSessionObject) {
            py.append(SESSION_VAR + " = requests.session()");
        }
        ...
        for (IHttpRequestResponse message : messages) {
            ...
            if (cookiesExist && withSessionObject) {
                py.append('\n').append(SESSION_VAR + ".cookies.update(");
                py.append(prefix).append("cookies").append(')');
            }
            py.append('\n').append(prefix).append("res = ");
